...
define('STRIPE_SUCCESS_URL', 'http://localhost/BigPrizeDraw/success.php'); // NEEDS CHANGED
define('STRIPE_CANCEL_URL', 'http://localhost/BigPrizeDraw/cancel.php'); // NEEDS CHANGED
