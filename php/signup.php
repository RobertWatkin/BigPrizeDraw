...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password != $confirmPassword) {
        ...
        if (mysqli_num_rows($results) > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO tblusers (firstName, surname, email, password, phoneNumber, isAdmin) VALUES ('$firstName', '$surname', '$email', '$hashedPassword', '$phone','$isAdmin')");
